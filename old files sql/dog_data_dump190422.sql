...
CREATE TABLE `booking` (
  ...
  CONSTRAINT `booking_ibfk_2` FOREIGN KEY (`dog_id`) REFERENCES `dog` (`id`),
...
INSERT INTO `booking` VALUES (1,1,1,1,3),(2,1,1,2,1),(3,1,1,4,5),(4,1,1,5,7),(5,2,2,5,7),(6,2,2,4,5),(7,2,2,1,3),(8,3,3,5,10),(9,3,3,5,8),(10,1,4,5,7),(11,1,4,4,5),(12,1,4,3,2),(13,3,5,3,2),(14,3,5,5,7),(15,2,6,3,2),(16,3,7,1,3),(17,4,8,5,10),(18,5,9,5,7),(19,5,10,5,8),(20,5,10,3,2);
...
INSERT INTO `customer` VALUES (1,'John','Smith','johnsmith@madeupemail.com','07821935481',''),(2,'Angelina','Jolie','ang@madeupemail.com','07821935482',''),(3,'David','Tennant','doctorwho@tardis.com','07821000487',''),(4,'Sherlock','Holmes','sherlockandwatson@spy.com','07821115487',''),(5,'Art','Garfunkel','soundofsilence@folk.com','07833335487',''),(6,'Emma','Naylor','emmanaylz@gmail.com','07522505348','Ozzy'),(8,'Daniel','Guppy','Thebest@gmail.com','07522533444','Mr Penacalti'),(9,'Fred','Hendrix','FredHed@gmail.com','07882100921','Jam'),(10,'Emma','Naylor','emmanaylz@gmail.com','07882100921','Fred');
...
CREATE TABLE `dog` (
  ...
  CONSTRAINT `dog_ibfk_1` FOREIGN KEY (`temperament`) REFERENCES `dog_category` (`id`),
...
-- Dump completed on 2022-04-19 20:30:40
